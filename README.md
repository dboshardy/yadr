...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/dboshardy/yadr/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/dboshardy/yadr/master/install.sh`" -s ask
```
